export const HOSTING_PROVIDER_IDS = ["docker", "fly", "aws", "render"] as const;
...
export type SandboxBackendId = "local" | "sprites" | "aws" | "agent37" | "render";
...
export const SANDBOX_BACKEND_POLICY: Record<Target, SandboxBackendPolicy> = {
  docker: { allowed: ["local", "sprites", "agent37", "render"], requireExplicit: false },
  fly: { allowed: ["sprites", "agent37", "render"], requireExplicit: false },
  aws: { allowed: ["sprites", "aws", "agent37", "render"], requireExplicit: true },
  render: { allowed: ["render"], requireExplicit: false },
};
