---
name: deploy-qm
description: Deploy the QM package from an organization-owned repository into Fly.io, AWS, or Render, onboard an administrator, configure connectors, and optionally activate Slack.
---
